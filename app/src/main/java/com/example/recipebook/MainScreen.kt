...
fun getCourses(navController: NavController)  {
    ...
    if (courses.isEmpty()) {
        ...
        RecipePage(recipes = courses, navController = navController, bottompadding = paddingValue)
    }
...
fun getDrinks(navController: NavController)  {
    ...
    if (drinks.isEmpty()) {
        ...
        val paddingValue = 80.dp
        RecipePage(recipes = drinks, navController = navController, bottompadding = paddingValue)
    }
//
}
...
fun getIndianRecipes(navController: NavController)  {
    ...
    if (iRecipes.isEmpty()) {
        ...
        val paddingValue = 80.dp
        RecipePage(recipes = iRecipes, navController = navController, bottompadding = paddingValue)
    }
